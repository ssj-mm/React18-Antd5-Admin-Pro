export default function initLoginBg(){
    var windownW = document.documentElement.clientWidth || document.body.clientWidth;
    var windownH = document.documentElement.clientHeight || document.body.clientHeight;
    var canvas = document.getElementById('canvas'),
		ctx = canvas.getContext('2d'),
		w = canvas.width = windownW,
		h = canvas.height = windownH,
